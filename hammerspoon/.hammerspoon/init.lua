...
hs.hotkey.bind(hyper, "h", function() hs.reload() end)
-- Open Finder
...
-- hs.hotkey.bind(hyper, "g", function() openApp("/Applications/GitHub Desktop.app", "GitHub") end)
...
-- hs.hotkey.bind(hyper, "v", function() openApp("/Applications/Visual Studio Code.app") end)
