...
hs.hotkey.bind(hyper, "l", function() openApp("/Applications/Claude.app", "Claude") end)
hs.hotkey.bind(hyper, "i", function() openApp("/Applications/Gemini.app", "Gemini") end)
...
hs.hotkey.bind(hyper, "p", function() openApp("/System/Applications/Reminders.app", "Reminders") end)
hs.hotkey.bind(hyper, "o", function() openApp("/Applications/Obsidian.app", "Obsidian") end)
